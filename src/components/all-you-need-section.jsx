    ...
    <div className="all-you-need-section lg:py-20 bg-white">
      ...
      <div className="container pb-20 lg:px-0">
        <div className="hidden lg:flex blocks-row text-center lg:justify-between lg:pt-20 xl:justify-center scaleup lg:max-w-[1020px] m-auto lg:gap-[10px] flex-wrap">
          <div className='block block-1  z-10w-[33.33%] lg:w-[160px] mb-[30px] lg:mb-[50px] relative' data-connect='block-3, block-7, block-8'>
          ...
          <div className='block block-2  z-10w-[33.33%] lg:w-[160px] mb-[30px] lg:mb-[50px] relative' data-connect='block-1, block-7, block-8, block-9, block-10'>
            <div className='block-inner'>
          ...
          <div className='block block-3  z-10w-[33.33%] lg:w-[160px] mb-[30px] lg:mb-[50px] relative' data-connect='block-1, block-9, block-10'>
            <div className='block-inner'>
          ...
          <div className='block block-4  z-10w-[33.33%] lg:w-[160px] mb-[30px] lg:mb-[50px] relative' data-connect='block-7, block-8, block-9'>
            <div className='block-inner'>
          ...
          <div className='block block-5  z-10w-[33.33%] lg:w-[160px] mb-[30px] lg:mb-[50px] relative' data-connect='block-1, block-6, block-8, block-9, block-10'>
            <div className='block-inner'>
          ...
          <div className='block block-6  z-10w-[33.33%] lg:w-[160px] mb-[30px] lg:mb-[50px] relative' data-connect='block-5'>
            <div className='block-inner'>
          ...
          <div className='block block-7  z-10w-[33.33%] lg:w-[160px] custom-w1 mb-[30px] lg:mb-[50px] relative' data-connect='block-2,block-8,block-10, block-4, block-9'>
            <div className='block-inner'>
          ...
          <div className='block block-9  z-10w-[33.33%] lg:w-[160px] custom-w1 mb-[30px] lg:mb-[50px] relative' data-connect='block-1,block-2, block-4, block-8, block-7, block-10'>
            <div className='block-inner'>
          ...
          <div className='block block-8  z-10w-[33.33%] lg:w-[160px] custom-w1 mb-[30px] lg:mb-[50px] relative' data-connect='block-1, block-2, block-4,block-7, block-9, block-10'>
            <div className='block-inner'>
          ...
          <div className='block block-10 z-10 w-[33.33%] lg:w-[160px] custom-w1 mb-[30px] lg:mb-[50px] relative' data-connect='block-3, block-5, block-8'>
            <div className='block-inner'>
          ...
          <div className='block block-11 w-[33.33%] lg:w-[160px] custom-w1 mb-[30px] lg:mb-[50px] relative' data-connect='block-6'>
            <div className='block-inner'>
