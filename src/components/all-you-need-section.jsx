        ...
        <div className="hidden lg:flex blocks-row text-center lg:justify-between lg:pt-20 xl:justify-center scaleup lg:max-w-[1020px] m-auto lg:gap-[10px] flex-wrap">
          <div className='z-[50] hover:z-0 block block-1  w-[33.33%] lg:w-[160px] mb-[30px] lg:mb-[50px] relative' data-connect='block-3, block-7, block-8'>
            <div className='block-inner '>
              <div className='absolute top-[40px] left-[90px] w-[310px] rotate-[0deg] bg-gradient-to-r from-[#5BBA6F] to-[#289590] h-[1px] z-20aa'></div>
              <div className='absolute top-[128px] xl:hidden  left-[60px] w-[445px] rotate-[21deg] bg-gradient-to-r from-[#5BBA6F] to-[#FFBF00] h-[1px] z-20aa'></div>
              ...
              <div className='absolute top-[132px] hidden xl:block left-[79px] w-[420px] rotate-[21deg] bg-gradient-to-r from-[#5BBA6F] to-[#FFBF00] h-[1px] z-20aa'></div>
          ...
          <div className='z-[50] hover:z-0 block block-2  w-[33.33%] lg:w-[160px] mb-[30px] lg:mb-[50px] relative' data-connect='block-1, block-7, block-8, block-9, block-10'>
            <div className='block-inner'>
              ...
              <div className='absolute top-[130px] lg:hidden xl:block left-[69px] w-[290px] rotate-[32deg] bg-gradient-to-r from-[#ED254E] to-[#FFBF00] h-[1px] z-20aa'></div>
          ...
          <div className='z-[50] hover:z-0 block block-3  w-[33.33%] lg:w-[160px] mb-[30px] lg:mb-[50px] relative' data-connect='block-1, block-9, block-10'>
            <div className='block-inner'>
              ...
              <div className='absolute top-[135px] lg:hidden xl:block left-[58px] w-[300px] rotate-[33deg] bg-gradient-to-r from-[#289590] to-[#5076D8] h-[1px] z-20aa'></div>
              <Image
          ...
          <div className='z-[50] hover:z-0 block block-5  w-[33.33%] lg:w-[160px] mb-[30px] lg:mb-[50px] relative' data-connect='block-1, block-6, block-8, block-9, block-10'>
            <div className='block-inner'>
              ...
              <div className='absolute top-[128px] right-[21px] w-[155px] rotate-[105deg] xl:hidden bg-gradient-to-r from-[#F67227] to-[#5076D8] h-[1px] z-20aa'></div>
              <div className='absolute top-[128px] right-[42px] w-[155px] rotate-[115deg] lg:hidden xl:block bg-gradient-to-r from-[#F67227] to-[#5076D8] h-[1px] z-20aa'></div>
          ...
          <div className='z-[50] hover:z-0 block block-6  w-[33.33%] lg:w-[160px] mb-[30px] lg:mb-[50px] relative' data-connect='block-5, block-11'>
            <div className='block-inner'>
              ...
              <div className='absolute top-[132px] right-[-6px] w-[166px] rotate-[90deg] xl:hidden bg-gradient-to-r from-[#B84FD7] to-[#D74FA9] h-[1px] z-20aa'></div>
              <div className='absolute top-[132px] right-[42px] w-[166px] rotate-[115deg] lg:hidden xl:block bg-gradient-to-r from-[#B84FD7] to-[#D74FA9] h-[1px] z-20aa'></div>
              <Image
          ...
          <div className='z-[50] hover:z-0 block block-7  w-[33.33%] lg:w-[160px] custom-w1 mb-[30px] lg:mb-[50px] relative' data-connect='block-2,block-8,block-10, block-4, block-9'>
            <div className='block-inner '>
              <div className='absolute bottom-[88px] left-[310px] w-[180px] rotate-[180deg] xl:hidden bg-gradient-to-r to-[#06AED5] from-[#FFBF00] h-[1px] z-20aa'></div>
              <div className='absolute bottom-[88px] left-[260px] w-[180px] rotate-[180deg] lg:hidden xl:block bg-gradient-to-r to-[#06AED5] from-[#FFBF00] h-[1px] z-20aa'></div>
          ...
          <div className='z-[50] hover:z-0 block block-9  w-[33.33%] lg:w-[160px] custom-w1 mb-[30px] lg:mb-[50px] relative' data-connect='block-1,block-2, block-4, block-8, block-7, block-10'>
            <div className='block-inner'>
              ...
              <div className='absolute bottom-[88px] right-[94px] w-[190px] xl:hidden rotate-[180deg] bg-gradient-to-r from-[#06AED5] to-[#43C798] h-[1px] z-20aa'></div>
              ...
              <div className='absolute bottom-[191px] left-[80px] w-[330px] xl:hidden rotate-[151deg] bg-gradient-to-r from-[#A682FF] to-[#43C798] h-[1px] z-20aa'></div>
              <div className='absolute bottom-[176px] right-[50px] w-[270px] xl:hidden rotate-[40deg] bg-gradient-to-r from-[#5BBA6F] to-[#43C798] h-[1px] z-20aa'></div>
              ...
              <div className='absolute bottom-[88px] right-[84px] w-[180px] rotate-[180deg] lg:hidden xl:block bg-gradient-to-r to-[#06AED5] from-[#43C798] h-[1px] z-20aa'></div>
              ...
              <div className='absolute bottom-[176px] right-[50px] w-[295px] rotate-[35deg] lg:hidden xl:block bg-gradient-to-r from-[#5BBA6F] to-[#43C798] h-[1px] z-20aa'></div>
              <Image
          ...
          <div className='z-[50] hover:z-0 block block-8  w-[33.33%] lg:w-[160px] custom-w1 mb-[30px] lg:mb-[50px] relative' data-connect='block-1, block-2, block-4,block-7, block-9, block-10'>
            <div className='block-inner'>
              <div className='absolute bottom-[88px] right-[300px] w-[190px] rotate-[180deg] bg-gradient-to-r xl:hidden to-[#06AED5] from-[#43C798] h-[1px] z-20aa'></div>
              <div className='absolute bottom-[88px] right-[103px] w-[180px] rotate-[180deg] bg-gradient-to-r xl:hidden to-[#06AED5] from-[#FFBF00] h-[1px] z-20aa'></div>
              ...
              <div className='absolute bottom-[88px] right-[230px] w-[190px] rotate-[180deg] bg-gradient-to-r lg:hidden xl:block to-[#06AED5] from-[#43C798] h-[1px] z-20aa'></div>
